          ...
          <div class="card__inner">
            ...
            <div class="card__settings">
              <div class="card__details">
                <div class="card__dates">
                  ...
                  <fieldset class="card__repeat-days">
                    ...
                    ${Object.entries(this._repeatingDays).map(([day, value]) => getRepeatingDaysCheckbox(day, value)).join(``)}
                  </fieldset>
                </div>
                ...
                <div class="card__hashtag">
                  ...
                  ${Array.from(this._tags).map((el) => getCardHashtag(el)).join(` `)}
                  </div>
              ...
              <div class="card__colors-inner">
                ...
                ${ALL_COLORS.map((colorElement) => getColorRadioInput(colorElement, colorElement === this._color)).join(``)}
                </div>
              </div>
            </div>
...
const getTaskCardEditComponent = ({
  description,
  dueDate,
  repeatingDays,
  tags,
